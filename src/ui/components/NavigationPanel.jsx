...
export const NavigationPanel = () => {
    ...
    const setView = (viewType) => {
        window.dispatchEvent(new CustomEvent('canvas-set-view', { detail: { viewType } }));
    };

    return (
        <div className="absolute top-4 right-4 z-50 flex flex-col gap-1 bg-slate-900/80 backdrop-blur border border-slate-700 p-1 rounded shadow-lg pointer-events-auto">
            <button
